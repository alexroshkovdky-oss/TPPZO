    ...
    <>
      ...
      <section className="section-spacing bg-[var(--color-background)]">
        <div className="site-container grid gap-14 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
          <SectionHeading
            eyebrow="Миссия"
            title="Брать на себя организационный вес там, где бизнесу нужен полный маршрут решения."
            description="Союз работает с обращениями по промышленности, торговле, кооперации, документам, профильным процедурам и деловым коммуникациям."
          />

          <div className="space-y-6 text-lg leading-8 text-[var(--color-muted)]">
            <p>
              Наша задача — не оставить предпринимателя один на один с регламентами, письмами,
              документами и разрозненными контактами. Союз собирает вопрос в управляемый процесс
              и сопровождает его по шагам.
            </p>
            <p>
              Мы выстраиваем деловой контур вокруг задачи: фиксируем цель, подключаем нужных
              участников, ведём коммуникацию, следим за логикой документов и доводим обращение
              до итогового этапа.
            </p>
          </div>
        </div>
      ...
      <section className="section-spacing bg-[var(--color-background)]">
        <div className="site-container space-y-12">
          <SectionHeading
            ...
            title="Практическая работа строится вокруг полного прохождения вопроса."
